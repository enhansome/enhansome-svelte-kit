...
* [Virtual DOM is pure overhead](https://svelte.dev/blog/virtual-dom-is-pure-overhead) - A must read if you want to make sense of *why FE compiler frameworks?*
...
* [**Rich Harris** on SvelteKit for SPAs](https://twitter.com/Rich_Harris/status/1376578502833606658)
* [**Mike**'s thoughts on maturity of Svelte/SvelteKit](https://twitter.com/htmleverything/status/1515000240134242309)
...
* [Svelte(Kit) TypeScript Showcase](https://github.com/ivanhofer/sveltekit-typescript-showcase) ⭐ 718 | 🐛 0 | 🌐 Svelte | 📅 2023-07-10
...
* [SvelteKit with Web3](https://github.com/wighawag/jolly-roger) ⭐ 207 | 🐛 0 | 🌐 TypeScript | 📅 2026-09-20
...
* [SvelteKit with NetlifyCMS](https://github.com/buhrmi/sveltekit-netlify-cms) ⭐ 58 | 🐛 1 | 🌐 HTML | 📅 2022-04-09
* [SvelteKit with oAuth2](https://github.com/MacFJA/svelte-oauth2) ⭐ 43 | 🐛 5 | 🌐 TypeScript | 📅 2022-09-24
* [SvelteKit with Magic Link](https://github.com/srmullen/sveltekit-magic) ⭐ 40 | 🐛 3 | 🌐 Svelte | 📅 2022-03-27(with [magic.link](https://magic.link/)
* [SvelteKit with Notion](https://github.com/one-aalam/svelte-notion-kit) ⭐ 36 | 🐛 2 | 🌐 Svelte | 📅 2021-07-30
* [SvelteKit on Edge(Cloudflare Workers)](https://github.com/hazcod/cloudflare-workers-svelte) ⭐ 18 | 🐛 23 | 🌐 Svelte | 📅 2025-12-12
* [SvelteKit with Solana](https://github.com/silvestrevivo/solana-svelte-wallet) ⭐ 9 | 🐛 0 | 🌐 Svelte | 📅 2021-10-17
* [SvelteKit with Metamask/Unlock-Protocol](https://github.com/novum-insights/sveltekit-unlock-firebase) ⭐ 7 | 🐛 1 | 🌐 TypeScript | 📅 2022-02-25
* [SvelteKit with Elementary Audio](https://github.com/bgins/svelte-elementary-template) ⭐ 7 | 🐛 1 | 🌐 JavaScript | 📅 2023-11-20 - A SvelteKit template for Elementary Audio apps
...
* [Chrome Extension](https://github.com/michmich112/sveltekit-adapter-chrome-extension) ⭐ 155 | 🐛 10 | 🌐 JavaScript | 📅 2026-05-06
* [AWS Lambda](https://github.com/yarbsemaj/sveltekit-adapter-lambda) ⭐ 80 | 🐛 10 | 🌐 TypeScript | 📅 2024-06-12
* [AppEngine](https://github.com/HalfdanJ/svelte-adapter-appengine) ⭐ 73 | 🐛 14 | 🌐 JavaScript | 📅 2025-05-19
* [Express](https://github.com/mankins/svelte-adapter-express) ⚠️ Archived
* [Wordpress Shortcode](https://github.com/tomatrow/sveltekit-adapter-wordpress-shortcode) ⭐ 34 | 🐛 1 | 🌐 JavaScript | 📅 2022-10-02
* [AWS CDK](https://github.com/juranki/sveltekit-cdk) ⭐ 31 | 🐛 3 | 🌐 TypeScript | 📅 2023-07-03
* [HTML Templating Languages](https://github.com/idleberg/sveltekit-adapter-html-like) ⭐ 26 | 🐛 0 | 🌐 JavaScript | 📅 2026-09-09
* [AWS CDK (DIY)](https://github.com/juranki/diy-sveltekit-cdk-adapter) ⭐ 11 | 🐛 0 | 🌐 TypeScript | 📅 2022-01-21
* [Architect/Begin](https://github.com/architect/sveltekit-adapter) ⭐ 10 | 🐛 0 | 🌐 Svelte | 📅 2022-03-03
* [AWS Lambda@Edge](https://github.com/efess/svelte-adapter-lambda-edge) ⭐ 2 | 🐛 0 | 🌐 JavaScript | 📅 2021-09-09
* [uWebSocket](https://github.com/UnlimitedBytes/adapter-uwebsockets) ⭐ 2 | 🐛 1 | 📅 2022-07-19 (in development)
* [Nest.js](https://github.com/onivoro/svelte-adapter-nestjs) ⭐ 1 | 🐛 0 | 🌐 JavaScript | 📅 2022-01-02
* [Github Pages](https://github.com/ota-meshi/svelte-adapter-ghpages) ⭐ 1 | 🐛 6 | 🌐 TypeScript | 📅 2026-08-31
* [Begin](https://github.com/ryanbethel/sveltekit-begin-adapter) ⭐ 0 | 🐛 1 | 🌐 JavaScript | 📅 2021-07-28
...
* [Svemix](https://github.com/svemix/svemix) ⭐ 330 | 🐛 8 | 🌐 JavaScript | 📅 2023-08-23 Like Remix.run(Full-Stack addition) to SvelteKit. Write your server code inside svelte files, handle sessions, forms and SEO easily.
* [Sveltin](https://github.com/sveltinio/sveltin) ⚠️ Archived - The Smartest Way to Build SvelteKit powered static websites: a powerful CLI for your next SvelteKit static website
* [SvelteKit Zero API](https://github.com/Refzlund/sveltekit-zero-api/tree/master/lib) ⭐ 42 | 🐛 1 | 🌐 TypeScript | 📅 2025-06-21
* [Svelte Zero API](https://github.com/ymzuiku/svelte-zero-api) ⭐ 22 | 🐛 0 | 🌐 JavaScript | 📅 2023-07-28
...
* [SvelteKit Embed Components](https://github.com/spences10/sveltekit-embed) ⭐ 239 | 🐛 15 | 🌐 TypeScript | 📅 2026-09-19
* [Svelte Kit Cookie Session](https://github.com/pixelmund/svelte-kit-cookie-session) ⭐ 189 | 🐛 0 | 🌐 TypeScript | 📅 2025-01-07 - Encrypted "stateless" cookie sessions for SvelteKit
...
* [Coolify](https://github.com/coollabsio/coolify) ⭐ 62,085 | 🐛 712 | 🌐 PHP | 📅 2026-09-20 - An open-source & self-hostable Heroku / Netlify alternative.
* [evidence.dev](https://github.com/evidence-dev/evidence) ⭐ 6,949 | 🐛 39 | 🌐 TypeScript | 📅 2026-09-18 - Business Intelligence for Modern Data Teams
* [MacOS Web](https://github.com/puruvj/macos-web) ⭐ 2,669 | 🐛 45 | 🌐 Svelte | 📅 2026-07-05 - Replicates some of the Mac OS(Monterey, at the time of writing)'s desktop experience on web, using Svelte!
* [Svelte Commerce](https://github.com/itswadesh/svelte-commerce) ⭐ 1,813 | 🐛 2 | 🌐 Svelte | 📅 2026-09-09
* [Other Awesome Svelte-kit Projects](https://github.com/janosh/awesome-svelte-kit) ⭐ 1,322 | 🐛 1 | 🌐 TypeScript | 📅 2026-09-01
...
* [SvelteKit Snippets](https://github.com/stordahl/sveltekit-snippets) ⭐ 41 | 🐛 3 | 📅 2022-05-16
* [Dockit](https://github.com/crinklesio/dockit) ⭐ 29 | 🐛 0 | 🌐 Svelte | 📅 2022-01-20 - Markdown-based document site
* [Naabu](https://github.com/naabu/naabu) ⭐ 26 | 🐛 10 | 🌐 Svelte | 📅 2026-02-13
* [Flowbite](https://github.com/edde746/flowbite-svelte-but-better) ⭐ 18 | 🐛 2 | 🌐 Svelte | 📅 2022-05-30 - Clone of flowbite-react but for Svelte without the jank of flowbite-svelte
* [Reddit Client](https://github.com/jatinhemnani01/reddit-client) ⭐ 10 | 🐛 1 | 🌐 Svelte | 📅 2021-07-20
...
* [Files](https://files.community/)([source](https://github.com/files-community/website) ⭐ 464 | 🐛 6 | 🌐 Svelte | 📅 2026-09-17) - 3rd Party File Manager for Windows
