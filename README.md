...
* [SvelteKit with Web3](https://github.com/wighawag/jolly-roger) ⭐ 206 | 🐛 0 | 🌐 TypeScript | 📅 2026-09-12
...
* [Svemix](https://github.com/svemix/svemix) ⭐ 331 | 🐛 8 | 🌐 JavaScript | 📅 2023-08-23 Like Remix.run(Full-Stack addition) to SvelteKit. Write your server code inside svelte files, handle sessions, forms and SEO easily.
...
* [SvelteKit Embed Components](https://github.com/spences10/sveltekit-embed) ⭐ 239 | 🐛 15 | 🌐 TypeScript | 📅 2026-09-15
...
* [Coolify](https://github.com/coollabsio/coolify) ⭐ 61,872 | 🐛 698 | 🌐 PHP | 📅 2026-09-16 - An open-source & self-hostable Heroku / Netlify alternative.
* [evidence.dev](https://github.com/evidence-dev/evidence) ⭐ 6,941 | 🐛 38 | 🌐 TypeScript | 📅 2026-09-16 - Business Intelligence for Modern Data Teams
* [MacOS Web](https://github.com/puruvj/macos-web) ⭐ 2,666 | 🐛 46 | 🌐 Svelte | 📅 2026-07-05 - Replicates some of the Mac OS(Monterey, at the time of writing)'s desktop experience on web, using Svelte!
* [Svelte Commerce](https://github.com/itswadesh/svelte-commerce) ⭐ 1,809 | 🐛 2 | 🌐 Svelte | 📅 2026-09-09
...
* [Files](https://files.community/)([source](https://github.com/files-community/website) ⭐ 463 | 🐛 6 | 🌐 Svelte | 📅 2026-09-16) - 3rd Party File Manager for Windows
